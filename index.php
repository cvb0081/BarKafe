        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    ...
                    <h1 class="brand-name">Bar Kafe</h1>
                    <hr class="tagline-divider">
                    <h2>
                        <small>By
                            <strong>Egel , Rexhino and Fatjon</strong>
                        </small>
                    </h2>
                </div>
            </div>
            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">How to make
                        <strong>THE PERFECT MACCHIATO</strong>
                    </h2>
                    <hr>
                    <img class="img-responsive img-border img-left" src="img/intro-pic.jpg" alt="">
                    <hr class="visible-xs">
                    <p>The Macchiato or Caffè macchiato is a simple, often overlooked coffee that takes its name from the Italian for "stained" or "spotted" meaning the literal translation of caffè macchiato is "stained coffee" or coffee with a spot of milk.
                        ...
                        A great option for taking the 'bite' out of standard espresso, the macchiato is a key menu option for the purist coffee shop.</p>
                </div>
            </div>
        </div>
